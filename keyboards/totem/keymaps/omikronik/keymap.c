...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    KC_ESC,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,      KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  MUTE,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    KC_LGUI,  KC_EXLM,  KC_AT,    KC_LPRN,  KC_RPRN,  KC_DQT,    KC_ASTR,  KC_AMPR,  KC_UNDS,  KC_BSLS,  KC_PIPE,  _______,
                                  _______,  _______,  SYM2,      _______,   _______,  _______
 ),

   [_SYM2] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
              _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,   _______,
              _______,  KC_DLR,   KC_LBRC,  KC_RBRC,   KC_GRV,   _______,  _______,  _______,  _______,   _______,
    _______,  KC_CIRC,  KC_GRV,   KC_LT,    KC_GT,     KC_TILD,  _______,  _______,  _______,  _______,   _______, _______,
                                  _______,  _______,   _______,  _______,  _______,  _______
 ),

   [_EXT] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_ESC,   _______,  DSK_L,    DSK_R,     _______,  KC_PGUP,  KC_PGDN,  KC_END,   KC_HOME,   KC_CAPS,
              M_LALT,   M_LGUI,   M_LSFT,   M_CTRL,    M_RALT,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,   KC_DEL,
    KC_LGUI,  UNDO,     CUT,      COPY,     KC_TAB,    PSTE,     DEL_W,    KC_BSPC,  SSHOT,    _______,   SETTINGS, _______,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,  KC_VOLD,  KC_MPLY,  KC_VOLU,  _______,   _______,  _______,  _______,  _______,  _______,  KC_F12,   GAME1,
                                  _______,  _______,   _______,  _______,  _______,  _______
 ),
